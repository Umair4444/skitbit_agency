  ...
  return (
    <>
      ...
      <section className="relative bg-black text-white py-20 px-6 md:px-12 lg:px-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">About Skitbit International</h1>
      ...
      <section className="py-20 bg-black text-center text-white px-6">
        ...
        <p className="text-lg opacity-80 mb-8">Let Skitbit International bring your products to life.</p>
        <a
          href="/contact"
