...
function FeatureItem({ text, muted = false }: Feature) {
  return (
    <li className="flex items-start gap-2">
      <CheckCircle2 className="bg-lime-400 mt-0.5 h-4 w-4 rounded-full" />
      <span
    ...
    <section id="pricing" className="text-white">
      <div className="container mx-auto px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mx-auto mb-4 inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-lime-400">
            Our Pricing and Packages
          </div>
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
            Our Pricing.
          </h2>
          <p className="mx-auto mt-2 max-w-xl text-sm text-background/90">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {/* Startup */}
          <Card className="bg-foreground relative overflow-hidden rounded-2xl liquid-glass shadow-[0_12px_40px_rgba(0,0,0,0.3)] transition-all duration-300">
            <div
            ...
            <CardHeader className="space-y-3 pb-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  bg-foreground text-white border border-gray-800 hover:bg-accent-foreground cursor-pointer"
                >
                  View Example
                </Button>
                ...
                <Button
                  asChild
                  className="bg-lime-400 hover:bg-lime-600 flex-1 rounded-full px-4 py-2 text-sm font-medium text-black shadow 
             transition-[box-shadow,transform,filter] active:translate-y-[1px] cursor-pointer"
                >
          ...
          {/* Premium */}
          <Card className="bg-foreground relative overflow-hidden rounded-2xl liquid-glass-enhanced shadow-[0_16px_50px_rgba(0,0,0,0.4)] transition-all duration-300">
